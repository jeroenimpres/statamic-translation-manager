...
namespace Statamic\src\Exporting\Exporters\Support;
...
class XliffFileHeaderSKL extends XliffNode
{
    protected $name           = 'skl';
    protected $supportedNodes = [
        'external-file'    => 'Statamic\src\Exporting\Exporters\Support\XliffFileHeaderExternalFile',
    ];
}
class XliffFileHeaderExternalFile extends \Statamic\Addons\TranslationManager\Exporting\Exporters\Support\XliffNode
{
