...
use Statamic\Addons\TranslationManager\Exporting\Preparators\Collection;
use Statamic\API\URL;
use Statamic\src\Helpers\Locale;

use function Statamic\Addons\TranslationManager\Exporting\Preparators\class_basename;
