...
namespace Statamic\src\Helpers;

use Statamic\Addons\TranslationManager\Helpers\Collection;
use Statamic\API\Config;

use function Statamic\Addons\TranslationManager\Helpers\collect;
